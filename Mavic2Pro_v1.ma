...
//Last modified: Fri, Oct 09, 2020 02:40:06 PM
//Codeset: 1252
requires maya "2020";
...
fileInfo "UUID" "2CECB747-4352-5ADB-666D-338A7C31097B";
createNode transform -s -n "persp";
	rename -uid "86CE88A4-4F4E-3399-E324-1597024CF424";
	setAttr ".t" -type "double3" -29.256436086477041 50.294739458638738 117.0197103218069 ;
	setAttr ".r" -type "double3" 342.86164723601587 -734.59999999990532 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5D1DD4E7-4E59-C08F-93F6-DABAE6C96CBD";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 129.40906091194566;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EE814857-406C-57B3-4DA6-65B3CCA5D01A";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "186DAF2F-4A60-29D8-6750-0EBD9E4DB25E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "57EDC557-4DC1-4ECF-88BE-35833750B7E6";
createNode displayLayerManager -n "layerManager";
	rename -uid "D9B79B6C-413D-1EBF-4298-6C952BD5C1B0";
createNode displayLayer -n "defaultLayer";
	rename -uid "9FFBEE58-4AEE-D3CE-1B23-6EA9B8B298B1";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5797C85A-4D1E-AD83-7C2F-FFA4A212A190";
...
createNode polyTweak -n "polyTweak9";
	...
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk[52:55]" -type "float3"  -0.10536292 0.088770621 0
		 -0.10536292 0.088770621 0 -0.08913549 0 0 -0.089135461 0 0;
